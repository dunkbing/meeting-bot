...
func TestRecorder(t *testing.T) {
	...
	for _, test := range []struct {
	...
	}{
		{
			name: "file-default",
			f: func(t *testing.T) {
				testRecording(t, conf, "file-defaults", false)
			},
		},
		{
			name: "file-baseline",
			f: func(t *testing.T) {
				testRecording(t, conf, "file-baseline", false)
			},
		},
		{
			name: "file-high",
			f: func(t *testing.T) {
				testRecording(t, conf, "file-high", false)
			},
		},
		{
			name: "file-static",
			f: func(t *testing.T) {
				testRecording(t, conf, "file-static", true)
			},
		},
		{
			name: "stream-default",
